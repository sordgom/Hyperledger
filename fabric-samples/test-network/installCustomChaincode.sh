...
CHAINCODE_NAME="Customs"
CHAINCODE_VERSION="1"
CHAINCODE_PATH="../chaincode/Customs/build/install/Customs"
CHAINCODE_LANG="java"
CHAINCODE_LABEL="certification_2"
...
chaincodeAddCert() {
    ...
    --peerAddresses localhost:7051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE_ORG1\
    --peerAddresses localhost:9051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE_ORG2\
    -c '{"Args":["createCustomCert","CUSTOM3","name","id","org","toa","poa","in","v"]}'
...
chaincodeQueryCertById() {
    ...
    --peerAddresses localhost:7051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE_ORG1\
    --peerAddresses localhost:9051 --tlsRootCertFiles $CORE_PEER_TLS_ROOTCERT_FILE_ORG2\
    -c '{"Args":["queryCustomCert", "CUSTOM3"]}'
